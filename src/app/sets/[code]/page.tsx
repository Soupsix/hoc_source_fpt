            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3">
              {hasQuestions ? (
                <>
                  ...
                  <Link href={`/sets/${set.code}/quiz`} className="flex-1">
                    <button
                      type="button"
                      className="w-full py-3 px-5 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm sm:text-base shadow-md shadow-emerald-600/20 transition-all flex items-center justify-center gap-2"
                    >
